...
| 模块 | 交付 | 状态（2025-01-14） |
|------|------|-------------------|
| **contracts** | `PaymentVault` 充提；`MicroPaymentSettler` commitRoot + forceWithdraw | 🟡 Hardhat + localhost 冒烟；**Base Sepolia 已部署**（2025-01-14） |
...
**Base Sepolia Vault（84532 · 2025-01-14）**:
